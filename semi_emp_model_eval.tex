...
The variable speed data set was only available for the spool, reciprocating, and screw compressors. This data set has a fixed saturated suction and discharge temperature and superheat with variable operating speed/frequency. It includes speed variation ranging from XX - YY rpm for the spool compressor with Z points; XX - YY rpm for the reciprocating compressor with Z points, and XX - YY rpm for the screw compressor with Z points. The saturated suction/discharge and superheat for the compressors is XX and YY $^\circ$C, and ZZ K, XX and YY $^\circ$C, and ZZ K, XX and YY $^\circ$C, and ZZ K for the spool, reciprocating, and screw compressor, respectively. \com{Add in the relevant details here that I made space for}
